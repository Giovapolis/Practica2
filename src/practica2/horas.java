...
public class horas extends javax.swing.JFrame {
    ...
    public horas() {
        ...
        emp = lanzador.consulta.llenaCombo();
        for (int i = 0; i < emp.size(); i++) {
            trabajadores.addItem(emp.get(i));
        }
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(trabajadores, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pst.setInt(1, Integer.parseInt( trabajadores.getSelectedItem().toString() ) );
